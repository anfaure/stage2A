...
class TrajectoryApp(tk.Tk):
    def __init__(self):
        ...
        # Labels pour les positions cible et actuelle
        ttk.Label(control_frame, text="Cible:").grid(row=0, column=0, sticky='W')
        self.target_x = ttk.Entry(control_frame, width=5)
        self.target_x.grid(row=0, column=1)
        self.target_y = ttk.Entry(control_frame, width=5)
        self.target_y.grid(row=0, column=2)
        ...
        # Initialiser la connexion avec Harpia
        ...
        self.harpia.set_sample_mover_velocity(1)
    ...
    def move(self, dx, dy):
        ...
        # Déplacer l'échantillon avec Harpia
        self.harpia.sample_mover_go_to_xy_and_wait_stop(new_x, new_y)
    ...
    def reset_position(self):
        ...
        # Réinitialiser la position avec Harpia
        self.harpia.sample_mover_go_to_zero()
    ...
    def start_trajectory(self):
        ...
        # Déplacer l'échantillon avec Harpia
        self.harpia.sample_mover_go_to_xy_and_wait_stop(target_x, target_y)
    ...
    def draw_semicircle(self, direction):
        ...
        # Déplacer l'échantillon avec Harpia pour le demi-cercle
        for pos_x, pos_y in zip(x, y):
            self.harpia.sample_mover_go_to_xy_and_wait_stop(pos_x, pos_y)
