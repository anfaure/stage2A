...
for i in range(5):  # Pour chaque scan
    ax.plot(longueurs_donde, delay_scans[i], liste_delta_OD[i], label=f'Scan {i+1}', color=cm(i)) # Utilisation de la colormap

# Affichage de la légende et des axes
ax.legend()
