...
delta_OD = np.random.rand(len(delay), len(longueurs_donde)) # Exemple de delta OD aléatoire
...
c = ax.pcolormesh(longueurs_donde, delay, liste_delta_OD_1, vmin=-0.001, vmax=0.001)
