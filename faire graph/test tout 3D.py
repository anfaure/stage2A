...
colors = ['#edfa2f','#0db21b', '#ffffff', '#1b39cf','#da2ffa']  # Couleurs de départ (bleu), de fin(rouge), et intermédiaires (vert)
...
c = ax1.pcolormesh(longueurs_donde, delay, liste_delta_OD_1, cmap=cm, vmin=-0.001, vmax=0.001)
# Ajouter une barre de couleur
cbar = fig.colorbar(c, ax=ax1)
cbar.set_label('Delta OD')
# Ajouter les labels et le titre
ax1.set_xlabel('Longueur d\'onde (nm)')
ax1.set_ylabel('Délai (ps)')
ax1.set_title('la longueur d\'onde en fonction du delay et de delta OD1')

# Afficher SCAN 2
ax2.set_xlim([450, 900])
ax2.set_ylim([-4, 9])
# Plot des données avec une colormap
c = ax2.pcolormesh(longueurs_donde, delay, liste_delta_OD_2, cmap=cm, vmin=-0.001, vmax=0.001)
# Ajouter une barre de couleur
cbar = fig.colorbar(c, ax=ax2)
cbar.set_label('Delta OD')
# Ajouter les labels et le titre
ax2.set_xlabel('Longueur d\'onde (nm)')
ax2.set_ylabel('Délai (ps)')
ax2.set_title('la longueur d\'onde en fonction du delay et de delta OD2')
