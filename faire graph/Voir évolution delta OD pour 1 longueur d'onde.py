...
def afficher_cases_a_cocher(file_path):
    ...
    for i in range(scan_number):
        ...
        cases_a_cocher.append((i + 1, var))  # Stocker l'index et la variable
...
def executer_script():
    ...
    scans_a_examiner = [num for num, var in cases_a_cocher if var.get() == 1]
    ...
    plt.xlabel('Delay (ps)')  # Titre abscisse
